...
class User(models.Model):
    ...
    TgName = models.TextField(null=True, blank=True)
...
class Task(models.Model):
    ...
    IsReassigned = models.CharField(max_length=5, null=True, blank=True)
    Confirmation = models.CharField(max_length=5, null=True, blank=True)
...
class TaskReassign(models.Model):
    ...
    IsDone = models.CharField(max_length=5, null=True, blank=True)
